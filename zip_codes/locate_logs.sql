...
--   , b.location_id
-- FROM       log_some lg
-- INNER JOIN ip_blocks      b   ON ( lg.ip_address BETWEEN b.start_ip AND b.end_ip)
-- ;
...
LEFT JOIN ip_blocks      b 
   ON
        (lg.ip_address_12 = b.start_ip_12) AND
        (lg.ip_address BETWEEN b.start_ip AND b.end_ip)
;
